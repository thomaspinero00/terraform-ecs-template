# NOTE: Take into account that the project_name must be unique, 
#   since it will be used as a prefix for all the resources. It may fail if your name is too generic.

project_name = "myappv2testingagainii" # the name of your app
...
cluster_name     = "myappv2testingagainii-cluster"
